...
:comp_keil
:comp_uv4
if /I "%target%" == "debug"   copy /Y ..\..\..\mfs\build\uv4\%4_IntFlashDebug\mfs_%4_d.lib .
if /I "%target%" == "release" copy /Y ..\..\..\mfs\build\uv4\%4_IntFlashRelease\mfs_%4.lib .
goto comp_done
...
echo MFS Post-build operations done
