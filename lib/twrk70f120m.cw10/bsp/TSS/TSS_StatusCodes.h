...
***********************************************************************************************************************/
  ...
  #define TSS_KEYDETECT_STATUS_DECODER_READY      0x10u   /* Return value from the KeyDetector function */
  #define TSS_KEYDETECT_STATUS_ELECTRODES_READY   0x20u   /* Return value from the KeyDetector function */
  ...
  #define TSS_ERROR_SLIDER_ILLEGAL_CONTROL_TYPE   0x25u
  ...
  #define TSS_ERROR_ROTARY_ILLEGAL_PARAMETER      0x32u   /* Return values from the TSS_SliderConfig function */
  ...
  #define TSS_ERROR_ROTARY_ILLEGAL_CONTROL_TYPE   0x35u
