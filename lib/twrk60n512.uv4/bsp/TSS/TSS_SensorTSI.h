...
#ifndef __TSS_SENSORTSI_H__
  #define __TSS_SENSORTSI_H__
  ...
  */
  ...
  /*************** Sample Electrode Routine assignment *************/
    ...
    *********************************************************************************/
    ...
    /* Both OSC settings */
    #define TSS_TSI_SCANC_DELVOL           7   /* Delta Voltage settings for ElOSC and RefOSC 0 = 100mV, 7 = 600mV */
    /* TSI RefOSC definitions */
    ...
    /* TSI Resolution Determination */
    #define TSS_TSI_RESOLUTION_VALUE               (1 << (TSS_TSI_RESOLUTION-1))
    /* Recalibration High Threshold */
    #define TSS_TSI_RECALIBRATION_HIGH_THRESHOLD   (0xFFFF - ((0xFFFF - TSS_TSI_RESOLUTION_VALUE) / 32u ))
    /* Recalibration Low Threshold */
    #define TSS_TSI_RECALIBRATION_LOW_THRESHOLD    (TSS_TSI_RESOLUTION_VALUE - (TSS_TSI_RESOLUTION_VALUE / 32u ))
    /* EXTCHRG usable range for Recalibration */ 
    #define TSS_TSI_EXTCHRG_RANGE                  ((TSS_TSI_EXTCHRG_HIGH_LIMIT + 1u) - TSS_TSI_EXTCHRG_LOW_LIMIT) 
  
    #define TSS_TSI_CAP_LOW_LIMIT                  (TSS_TSI_RECALIBRATION_LOW_THRESHOLD  / 4u)
    #define TSS_TSI_CAP_HIGH_LIMIT                 (0xFFFF - ((0xFFFF - TSS_TSI_RECALIBRATION_HIGH_THRESHOLD) / 4u ))
    ...
    *********************************************************************************/
    ...
    #define TSS_CALC_TSI_REFCHRG_TABLE        ((u8RefChrgCalcTable[TSS_TSI_SCANC_CAPTRM][TSS_TSI_SCANC_DELVOL]*TSS_TSI_REFCHRG_FRQ/100) > 0) ? (u8RefChrgCalcTable[TSS_TSI_SCANC_CAPTRM][TSS_TSI_SCANC_DELVOL]*TSS_TSI_REFCHRG_FRQ/100)-1 : (u8RefChrgCalcTable[TSS_TSI_SCANC_CAPTRM][TSS_TSI_SCANC_DELVOL]*TSS_TSI_REFCHRG_FRQ/100)
  
    /*********************************************************************************
    *                    Derivative Headers Compatibility Macros
    *********************************************************************************/
        
    /* K70 not present there */
    #ifndef TSI_SCANC_AMCLKDIV_SHIFT
      #define TSI_SCANC_AMCLKDIV_SHIFT        5
    #endif
    /* K70 not present there */
    #ifndef TSI_SCANC_AMCLKDIV_MASK
