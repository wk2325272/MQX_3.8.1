...
#ifndef __TSS_SENSORTSIL_H__
  #define __TSS_SENSORTSIL_H__
  ...
  */
  ...
  /*************** Sample Electrode Routine assignment *************/
    ...
    *********************************************************************************/
    ...
    /* Both OSC settings */
    #define TSS_TSIL_CS2_DELVOL             0   /* Delta Voltage settings for ElOSC and RefOSC 0 = 300mV, 3 = 670mV */
  
    /* TSIL RefOSC definitions */
    #define TSS_TSIL_CS2_REFCHRG            6   /* Reference Oscillator Charge Current 0 = 500 nA, 7 = 64uA */     
    
    /* Masks */
    #define TSIL_CS2_REFCHRG_FIT(x)         (((UINT8)(((UINT8)(x))<<TSI_CS2_REFCHRG_BITNUM))&TSI_CS2_REFCHRG_MASK)
    #define TSIL_CS2_DELVOL_FIT(x)          (((UINT8)(((UINT8)(x))<<TSI_CS2_DVOLT_BITNUM))&TSI_CS2_DVOLT_MASK)
    ...
    #define TSS_TSIL_RECALIBRATION_HIGH_THRESHOLD   (0xFFFF - ((0xFFFF - TSS_TSIL_RESOLUTION_VALUE) / 32u ))
    /* Recalibration Low Threshold */
    #define TSS_TSIL_RECALIBRATION_LOW_THRESHOLD    (TSS_TSIL_RESOLUTION_VALUE - (TSS_TSIL_RESOLUTION_VALUE / 32u ))
    ...
    /* PS usable range for Recalibration */
    #define TSS_TSIL_PS_RANGE                       ((TSS_TSIL_PS_HIGH_LIMIT + 1u) - TSS_TSIL_PS_LOW_LIMIT)
  
    #define TSS_TSIL_CAP_LOW_LIMIT                  (TSS_TSIL_RECALIBRATION_LOW_THRESHOLD  / 4u)
    #define TSS_TSIL_CAP_HIGH_LIMIT                 (0xFFFF - ((0xFFFF - TSS_TSIL_RECALIBRATION_HIGH_THRESHOLD) / 4u ))
