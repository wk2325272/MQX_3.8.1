...
copy /Y ..\..\..\mqx\source\bsp\twrk60n512\init_lpm.h .
copy /Y ..\..\..\mqx\source\bsp\twrk60n512\bsp_cm.h .
if NOT EXIST TSS mkdir TSS
copy /Y ..\..\..\mqx\source\bsp\twrk60n512\TSS_SystemSetup.h .\TSS
...
copy /Y ..\..\..\mqx\source\bsp\twrk60n512\PE_LDD.h .\Generated_Code
...
if NOT EXIST ..\..\..\mqx\build\cw10\bsp_twrk60n512\Generated_Code\PE_LDD.h goto comp_done
...
copy /Y ..\..\..\mqx\source\bsp\twrk60n512\iar\ram_usr.icf .
copy /Y ..\..\..\mqx\source\bsp\twrk60n512\iar\intflash.icf .
copy /Y ..\..\..\mqx\source\bsp\twrk60n512\iar\intflash_usr.icf .
goto comp_done
...
if /I "%target%" == "debug"   copy /Y ..\..\..\mqx\build\uv4\twrk60n512_IntFlashDebug\bsp_twrk60n512_d.lib .
if /I "%target%" == "release" copy /Y ..\..\..\mqx\build\uv4\twrk60n512_IntFlashRelease\bsp_twrk60n512.lib .
copy /Y ..\..\..\mqx\source\bsp\twrk60n512\uv4\intflash.scf .
goto comp_done
...
call "%bat_file_dir%\write_readme.bat" > ..\twrk60n512_lib.txt
