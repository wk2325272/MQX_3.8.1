...
copy /Y ..\..\..\mqx\source\psp\cortex\MK60F15.h  .
...
if /I "%target%" == "debug"   copy /Y ..\..\..\mqx\build\uv4\twrk60f120m_IntFlashDebug\psp_twrk60f120m_d.lib .
if /I "%target%" == "release" copy /Y ..\..\..\mqx\build\uv4\twrk60f120m_IntFlashRelease\psp_twrk60f120m.lib .
goto comp_done
