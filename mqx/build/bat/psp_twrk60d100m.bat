...
copy /Y ..\..\..\mqx\source\psp\cortex\MK60D10.h  .
...
if /I "%target%" == "debug"   copy /Y ..\..\..\mqx\build\uv4\twrk60d100m_IntFlashDebug\psp_twrk60d100m_d.lib .
if /I "%target%" == "release" copy /Y ..\..\..\mqx\build\uv4\twrk60d100m_IntFlashRelease\psp_twrk60d100m.lib .
goto comp_done
