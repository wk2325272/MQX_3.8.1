...
:comp_keil
:comp_uv4
if /I "%target%" == "debug"   copy /Y ..\..\..\..\usb\host\build\uv4\%4_IntFlashDebug\usb_hdk_%4_d.lib .
if /I "%target%" == "release" copy /Y ..\..\..\..\usb\host\build\uv4\%4_IntFlashRelease\usb_hdk_%4.lib .
goto comp_done
...
echo USB_HDK Post-build operations done
